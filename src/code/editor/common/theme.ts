...
monaco.editor.defineTheme("meridia-theme", {
  ...
  colors: {
    ...
    "input.placeholderForeground": _theme.getColor("workbench.tabs.foreground"),
    ...
    "editorInlayHint.foreground": _theme.getColor("workbench.tabs.foreground"),
    "editorInlayHint.background": _kind === "light" ? "#f3f3f310" : "#00000000",
