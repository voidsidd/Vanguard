...
export class Empty extends CoreEl {
  ...
  private _createEl() {
    ...
    description.textContent = "Start from a clean, fresh Javascript project.";
    ...
    checkboxTitleFile.textContent = "Create a main.js file";
...
export const _javascriptEmpty = new Empty();
