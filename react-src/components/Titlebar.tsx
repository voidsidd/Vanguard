    ...
    <div className="h-12 bg-titlebar-background border-b flex items-center justify-between px-4 drag-region **:font-inter **:select-none">
      ...
      <>
        <Tooltip>
          <TooltipTrigger>
            <span
              className="py-1 px-2 rounded-md hover:bg-titlebar-item-hover-background hover:text-titlebar-item-hover-foreground no-drag cursor-pointer  "
              onClick={() => {
      ...
      <div className="mr-35 no-drag flex items-center gap-px">
        ...
        <Popover>
          <PopoverTrigger asChild>
            <button className="no-drag hover:bg-titlebar-item-hover-background cursor-pointer text-titlebar-icon-foreground p-1 rounded-md bg-transparent border-0  ">
